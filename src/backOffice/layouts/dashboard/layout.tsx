...
import { _account } from '../../config/nav-config-account';
import { MainSection } from '../core/main-section';
import { Searchbar } from '../components/searchbar';
import { _workspaces } from '../../config/nav-config-workspace';
...
import { navData as dashboardNavData } from '../../config/nav-config-dashboard';
